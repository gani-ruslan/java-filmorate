...
import ru.yandex.practicum.filmorate.infrastructure.jdbc.genre.repository.GenreJdbcRepository;
...
@Import({JdbcRowMapperConfig.class, GenreJdbcRepository.class})
class GenreJdbcRepositoryTest {
    ...
    void setAndGetFilmGenres() {
        ...
        List<Genre> attached = genres.getFilmGenres(filmId);
