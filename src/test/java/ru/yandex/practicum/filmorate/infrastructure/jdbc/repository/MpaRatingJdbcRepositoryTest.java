...
import ru.yandex.practicum.filmorate.infrastructure.jdbc.mpa.repository.MpaRatingJdbcRepository;
...
@Import({JdbcRowMapperConfig.class, MpaRatingJdbcRepository.class})
class MpaRatingJdbcRepositoryTest {
