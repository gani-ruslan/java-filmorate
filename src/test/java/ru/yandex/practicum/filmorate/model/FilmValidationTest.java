...
class FilmValidationTest {
    ...
    void shouldFailWhenDescriptionTooLong() {
        ...
        Film film = new Film(null, "Title", longDesc, LocalDate.of(2000, 1, 1), 100);
        Set<ConstraintViolation<Film>> violations = validator.validate(film);
        assertFalse(violations.isEmpty());
    ...
    void shouldFailWhenReleaseDateTooEarly() {
        Film film = new Film(null, "Title", "Desc", LocalDate.of(1700, 1, 1), 120);
        Set<ConstraintViolation<Film>> violations = validator.validate(film);
        assertFalse(violations.isEmpty());
    ...
    void shouldFailWhenDurationNegative() {
        Film film = new Film(null, "Title", "Desc", LocalDate.of(2000, 1, 1), -50);
        Set<ConstraintViolation<Film>> violations = validator.validate(film);
        assertFalse(violations.isEmpty());
    ...
    void shouldPassWhenFilmIsValid() {
        Film film = new Film(null, "Title", "Desc", LocalDate.of(2000, 1, 1), 120);
        Set<ConstraintViolation<Film>> violations = validator.validate(film);
